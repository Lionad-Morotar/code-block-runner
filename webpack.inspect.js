{
  mode: 'development',
  context: 'D:\\@Github\\code-block-run',
  node: {
    setImmediate: false,
    process: 'mock',
    dgram: 'empty',
  ...
  output: {
    path: 'D:\\@Github\\code-block-run\\dist',
    filename: 'js/[name].js',
    publicPath: '/',
        ...
        oneOf: [
          ...
          /* config.module.rule('pug').oneOf('pug-template') */
          {
            use: [
              ...
              {
                loader: 'D:\\@Github\\code-block-run\\node_modules\\_raw-loader@4.0.1@raw-loader\\dist\\cjs.js'
              },
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        title: 'code-block-runner',
        templateParameters: function () { /* omitted long function */ },
        template: 'D:\\@Github\\code-block-run\\public\\index.html'
      }
    ),
    ...
    new CopyPlugin(
      [
        {
          from: 'D:\\@Github\\code-block-run\\public',
          to: 'D:\\@Github\\code-block-run\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
